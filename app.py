...
def generate_random_task():
    ...
    competitions = list(COMPETITION_GEOGRAPHY.keys())
    ...
    templates = [
        ...
        lambda: f"Name a player who has won the {comp}" if "League" in comp or "Cup" in comp else f"Name a player who has won {comp}",
        lambda: f"Name a team that has won the {comp}" if "League" in comp or "Cup" in comp else f"Name a team that has won {comp}"
    ]
