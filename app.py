...
CLUB_DOMAINS = {
    ...
    "Manchester United": "manutd.com", "AC Milan": "acmilan.com"
}
...
def get_club_logo(text):
    ...
    for club, domain in CLUB_DOMAINS.items():
        if club.lower() in text.lower():
            ...
            # We don't break here in case there are two clubs (e.g. Real Madrid & AC Milan)
    return logo_html

def clean_text_and_add_assets(text):
    """Adds both flags and club logos to the text."""
